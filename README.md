...
```bash
claude mcp add py-code-mode -- uvx --from git+https://github.com/xpcmdshell/py-code-mode.git@v0.5.0 py-code-mode-mcp
```
...
```bash
uv add git+https://github.com/xpcmdshell/py-code-mode.git@v0.5.0
```
