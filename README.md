...
```bash
claude mcp add py-code-mode -- uvx --from git+https://github.com/xpcmdshell/py-code-mode.git@v0.14.0 py-code-mode-mcp --base ~/.code-mode
```
...
```bash
uv add git+https://github.com/xpcmdshell/py-code-mode.git@v0.14.0
```
