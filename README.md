...
```bash
claude mcp add py-code-mode -- uvx --from git+https://github.com/xpcmdshell/py-code-mode.git@v0.4.1 py-code-mode-mcp
```
...
```bash
uv add git+https://github.com/xpcmdshell/py-code-mode.git@v0.4.1
```
